<%@ Page Language="C#" MasterPageFile="~/student/student.master" AutoEventWireup="true" CodeFile="passwordModify.aspx.cs" Inherits="admin_passwordModify" Title="计软院论文管理系统-学生密码修改" %>
    ...
    &nbsp;<table border="0" style="background-image: url(../images/背景.jpg)">
        ...
        <tr>
            <td style="width: 100px; height: 16px;">
                密码：</td>
            <td style="width: 100px; height: 16px;">
                <asp:TextBox ID="oldpassword" runat="server" TextMode="Password" Rows="50"></asp:TextBox></td>
        ...
        <tr>
            <td style="width: 100px; height: 16px;">
                新密码：</td>
            <td style="width: 100px; height: 16px;">
                <asp:TextBox ID="newpassword" runat="server" TextMode="Password" MaxLength="50"></asp:TextBox></td>
            <td style="width: 125px; height: 16px;">
        ...
        <tr>
            <td style="width: 100px">
                确认新密码:</td>
            <td style="width: 100px">
                <asp:TextBox ID="confirmNewPassword" runat="server" TextMode="Password" MaxLength="50"></asp:TextBox></td>
        ...
        <tr>
            ...
            <td style="width: 100px">
                <asp:Button ID="change" runat="server" OnClick="change_Click" Text="更改" BackColor="#C0FFFF" BorderColor="Blue" ForeColor="Blue" />&nbsp;<asp:Button
                    ID="cancel" runat="server" OnClick="cancel_Click" Text="取消"  BackColor="#C0FFFF" BorderColor="Blue" ForeColor="Blue"/></td>
            <td style="width: 125px">
            </td>
        </tr>
    </table>
