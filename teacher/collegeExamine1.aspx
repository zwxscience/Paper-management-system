<%@ Page Language="C#" MasterPageFile="~/teacher/Teacher.master" AutoEventWireup="true" CodeFile="collegeExamine1.aspx.cs" Inherits="teacher_collegeExamine" Title="计软院论文管理系统-院领导审核 " %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Panel ID="Panel1" runat="server" GroupingText="院领导审核" Height="50px" Width="900px" BackImageUrl="~/images/背景.jpg">
        <table border="1" width="850">
            <caption >
                <span style="font-size: 16pt; font-family: 华文行楷;"><strong>院领导审核</strong></span></caption>
            <tr>
