<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="passwordModify.aspx.cs" Inherits="admin_passwordModify" Title="计软院论文管理系统-管理员密码修改" %>
    ...
    &nbsp;<table>
        ...
        <tr style=" border-top-color:Black">
            <td style="width: 100px; height: 16px;">
                密码：</td>
            <td style="width: 100px; height: 16px;">
                <asp:TextBox ID="oldpassword" runat="server" TextMode="Password" MaxLength="50"></asp:TextBox></td>
